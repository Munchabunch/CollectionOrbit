Module bas_DirObjNames
    ...
    Public Property FileExtension(ByVal str_FileName As String) As String
        ...
        Get
            ...
            str_UnpathedFileName = DirObjName(str_FileName)
    ...
    ''' <summary>
    ''' Remove the path from a pathed directory object name.
    ''' </summary>
    ''' <param name="str_PathedDirObjName">name of file including its path</param>
    ''' <returns>Unpathed file name</returns>
    Public Function DirObjName(ByVal str_PathedDirObjName As String) As String

        Dim i_Pos As Long

        '// Find the position of the last "\" in the pathed directory object name.
        i_Pos = InStrRev(str_PathedDirObjName, "\")

        DirObjName = str_PathedDirObjName.Substring(i_Pos)
    ...
    Public Property Path(ByVal str_PathedFileName As String) As String
        ...
        Get
            ...
            str_FileName = DirObjName(str_PathedFileName)
...
EH:
        ...
        Set(ByVal str_Value As String)
            ...
            str_PathedFileName = str_Value + DirObjName(str_PathedFileName)
